...
export default function LoginView({ onSuccess, onNavigateToRegister, onContinueAsGuest }: Props) {
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl border border-gray-200 p-8 max-w-sm w-full space-y-6">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">Welcome back to Sneaker Shop</p>
        </div>
